 ...
 * <li>obenPanel: GridLayout mit 8 Zeilen und 15+8 Spalten 
 * <li>mittePanel: GridLayout mit 15 Zeilen und 15+8 Spalten 
 * <li>untenPanel: FlowLayout für Anzeige, Lösung, Schwierigkeit und Neustart <br/>
 * <br/>
...
public class MyPanel extends JPanel {
	...
	private static final Color MYCOLOR = new Color(255,200,205); // lemon
	// Farbe wenn geklickt
	private static final Color COLOR_SELECTED = new Color(184,207,229); //light blue
	// Farbe wenn nicht geklickt
	private static final Color COLOR_NOT_SELECTED = Color.white;// new Color(00,255,255);
	...
	public MyPanel() {
		...
		// Zeile 1 bis 8
		JPanel obenPanel = new JPanel(new GridLayout((ROWS / 2 + 1), ROWS+ROWS/2+1, 2, 2));
		...
		JPanel mittePanel = new JPanel(new GridLayout(ROWS, ROWS+ROWS/2+1, 2, 2));
		// 
		...
		for (int i = 0, y = 0; y < ROWS; y++) {
			for (int x = 0; x < ROWS; x++) {
				this.jb[i] = new Fields(x, y,false,COLOR_SELECTED,COLOR_NOT_SELECTED); // Erstellen der Buttons
