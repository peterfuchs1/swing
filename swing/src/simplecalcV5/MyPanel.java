...
//	private static final Font SMALLER_FONT = new Font("monspaced", Font.PLAIN, 14);
	...
	private MyModel calcModel ; 		// Das Berechnungmodell.
...
//	private MyController myController; //wird durch den Parameter des
	 ...
	 * Konstruktor
	 */
	public MyPanel(MyController myController, MyModel calcModel) {
//		this.myController= myController;
	...
	public void numTyped(String ziffer, boolean consume) {
		...
		if(startNumber) {
        	...
        	//Dezimalpunkt abfangen
        	ziffer=dezimalPoint(ziffer); 
            //weitere Ziffer eingegeben
            displayField.setText(temp + ziffer);
